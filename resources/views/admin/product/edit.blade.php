                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-12 mb-3">
                           <h2 class="title"><a data-slug="admin/product" href="{{url('/admin/product')}}"><span>{{'Product'}}</span></a> > {{' Edit '}}</h2>
                        </div> 
                        <div class="col-12">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <div class="form-group ">
                                                                ...
                                                                <input required="" class="form-control" type="text" name="code"  value="{{$editData->code ?? ''}}">
                                                            </div>
                                                            <div class="form-group ">
                                                                <label>Product Quantity
                                                                <span class="text-danger">*</span>
                                                                </label>
                                                                <input required="" class="form-control" type="text" name="quantity"  value="{{$editData->quantity ?? ''}}">
                                                            </div>
                                                            <div class="form-group ">
                                                                <label>Product Price
                                                                <span class="text-danger">*</span>
                                                                </label>
                                                                <input required="" class="form-control" type="text" name="price" value="{{ $editData->price ?? '' }}">
                                                            </div>
                                                            <div class="col-md-3"></div>
                                                        </div>
                                                    </div>
